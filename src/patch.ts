...
function install(pgModule) {
  ...
  function PatchedPool(this: unknown, config: unknown) {
    if (!(this instanceof PatchedPool)) {
      return new (PatchedPool as unknown as new (c: unknown) => unknown)(config)
    }
  ...
  function PatchedClient(this: unknown, config: unknown) {
    if (!(this instanceof PatchedClient)) {
      return new (PatchedClient as unknown as new (c: unknown) => unknown)(config)
    }
